...
SECRET_KEY = config('SECRET_KEY', default='your-default-secret-key-change-this')
...
INSTALLED_APPS = [
    ...
    'django.contrib.gis',  # Add this for GeoDjango
    # Your apps
    'accounts',
    'vendor',
    'marketplace',
...
PAYPAL_SECRET_KEY = config('PAYPAL_SANDBOX_SECRET_KEY', default='')
